...
namespace Altinn.AccessManagement.Core.Services
{
    ...
    public class SingleRightsService : ISingleRightsService
    {
        ...
        public SingleRightsService(IContextRetrievalService contextRetrievalService, IPolicyInformationPoint pip, IPolicyAdministrationPoint pap, IProfileClient profile, IUserProfileLookupService profileLookup)
        {
