...
INSERT INTO accessmanagement.resource (resourceregistryid, resourcetype, resourcestatus, created, modified)
SELECT (doc->>'resourceregistryid')::text, (doc->>'resourcetype')::text, (doc->>'resourcestatus')::text, (doc->>'created')::timestamp,(doc->>'modified')::timestamp
