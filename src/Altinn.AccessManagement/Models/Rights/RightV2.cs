...
public class RightV2 : IExampleDataProvider<RightV2>
{
    /// <summary>
    ...
    /// <returns></returns>
    public static IEnumerable<RightV2> GetExamples(ExampleDataOptions options)
    {
        var json = """
            {
            "resource": [
            ...
            """;
        yield return JsonSerializer.Deserialize<RightV2>(json, new JsonSerializerOptions(JsonSerializerDefaults.Web));
    }
}
