...
export default function (data) {
  ...
  //tests
  // console.log('fjdskalfdjsøk fjsadlkf jldsøkfj kdsøj fkøadsjfk jsdkf jdsakf jdskjfakøjdkfjødskafjkødsajfkasdjfkdsøjfak');
  // console.log(org1.partyid);
  // console.log(org1.dagl.token);
...
export function postMaskinportenSchemaToOrgNumberTest() {
  ...
  console.log('postMaskinportenSchemaToOrgNumberTest');
  console.log(res.body);
