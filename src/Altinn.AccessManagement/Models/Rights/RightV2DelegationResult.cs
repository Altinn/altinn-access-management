...
public class RightV2DelegationResult : IExampleDataProvider<RightV2DelegationResult>
{
    /// <summary>
    ...
    /// <returns></returns>
    public static IEnumerable<RightV2DelegationResult> GetExamples(ExampleDataOptions options)
    {
        var json = """
            {
            "resource": [
            ...
            """;
        yield return JsonSerializer.Deserialize<RightV2DelegationResult>(json, new JsonSerializerOptions(JsonSerializerDefaults.Web));
    }
}
