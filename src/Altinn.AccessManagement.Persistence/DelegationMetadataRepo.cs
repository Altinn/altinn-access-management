...
namespace Altinn.AccessManagement.Persistence
{
    ...
    public class DelegationMetadataRepo : IDelegationMetadataRepository
    {
        ...
        public DelegationMetadataRepo(IDbConnection dbConnection, ILogger<DelegationMetadataRepository> logger)
        {
        ...
        public async Task<IEnumerable<DelegationChange>> GetAllAppDelegationChanges(string altinnAppId, int offeredByPartyId, int? coveredByPartyId, int? coveredByUserId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                _connection.Open();
                return await _connection.QueryAsync<DelegationChange>(new CommandDefinition(query, param, cancellationToken: cancellationToken));
            }
            catch (Exception e)
            {
